...
@section('title', 'Navigation — Amiri CMS')

@section('content')

<div class="page-header">
    <h1>Navigation</h1>
    <a href="{{ route('admin.navigation.create') }}" class="btn btn-primary">+ New</a>
</div>
        ...
        <div class="table-wrap">
            <table>
                ...
                <tbody>
                    @forelse ($items as $item)
                        ...
                        <td>
                            ...
                            <td style="text-align: right; white-space: nowrap;">
                                ...
                                <form method="POST" action="{{ route('admin.navigation.destroy', $item) }}" style="display: inline;" onsubmit="return confirm('Delete this item?')">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr><td colspan="10" class="empty-state">No items yet. <a href="{{ route('admin.navigation.create') }}">Create one</a></td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
